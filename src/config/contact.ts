...
export const CONTACT = {
  ...
  address: "Sai Puram Colony, Beside Sai Baba Temple, Gollapudi, Andhra Pradesh 520010",
  addressTe: "సాయి పురం కాలనీ, సాయి బాబా గుడి ప్రక్కన, గొల్లపూడి, ఆంధ్రప్రదేశ్ 520010",
  hours: [
